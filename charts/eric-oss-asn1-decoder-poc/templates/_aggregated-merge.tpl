...
*/ -}}
{{- define "eric-oss-asn1-decoder-poc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-asn1-decoder-poc.mergeAnnotations" -}}
  {{- include "eric-oss-asn1-decoder-poc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-asn1-decoder-poc.mergeLabels" -}}
  {{- include "eric-oss-asn1-decoder-poc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
